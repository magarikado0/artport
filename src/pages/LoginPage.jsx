  ...
  return (
    <div className="min-h-screen bg-ink flex flex-col items-center justify-center px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <button
          onClick={handleLogin}
          className="flex items-center gap-3 bg-paper text-ink rounded-2xl px-7 py-4 font-sans text-[14px] font-medium shadow-lg cursor-pointer border-none mb-4 w-full justify-center"
        >
